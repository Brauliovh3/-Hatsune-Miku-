...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
  try {
    ...
    let pp2 = 'https://qu.ax/OaOR.mp4'
    let pp3 = 'https://qu.ax/OaOR.mp4'
    let pp4 = 'https://qu.ax/OaOR.mp4'
    let pp5 = 'https://qu.ax/OaOR.mp4'
    let pp6 = 'https://qu.ax/OaOR.mp4'
    let pp7 = 'https://qu.ax/OaOR.mp4'
    let pp8 = 'https://qu.ax/OaOR.mp4'
    let pp9 = 'https://qu.ax/OaOR.mp4'
    let pp10 = 'https://qu.ax/OaOR.mp4'
    let pp11 = 'https://qu.ax/OaOR.mp4'
    let pp12 = 'https://qu.ax/OaOR.mp4'
    let pp13 = 'https://qu.ax/OaOR.mp4'
