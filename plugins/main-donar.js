let handler = async (m, { conn, command }) => {
    ...
    let str = `💙 *HOLA TE AGRADEZCO DE CORAZON SI ME APOYAS DONANDO. LOS BOTS ME INSPIRARON A CREAR A HATSUNE MIKU Y PUES SEGUIR ADELANTE CON LA CARRERA DE INGENIERO DE SOFTWARE*, *SEGUIRE EN ACTUALIZACION CON LA BOT Y MAS HASTA QUE ME GRADUE*,*GRACIAS POR TU APOYO*💙, no vemos pronto!
┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
💙 *Paypal - Donar*
${paypal}
┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈`;
